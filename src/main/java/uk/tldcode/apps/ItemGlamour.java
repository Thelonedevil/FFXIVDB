...
public class ItemGlamour {
    ...
    private String itemGlamour;
    @JsonProperty("reducible_classjob")
    private String reducibleClassjob;
     ...
     */
    @JsonProperty("item_glamour")
    public void setItemGlamour(String itemGlamour) {
     ...
     */
    @JsonProperty("reducible_classjob")
    public String getReducibleClassjob() {
     ...
     */
    @JsonProperty("reducible_classjob")
    public void setReducibleClassjob(String reducibleClassjob) {
     ...
     */
    @JsonProperty("classjob_repair")
    public String getClassjobRepair() {
     ...
     */
    @JsonProperty("classjob_repair")
    public void setClassjobRepair(String classjobRepair) {
     ...
     */
    @JsonProperty("slot_name")
    public void setSlotName(Object slotName) {
